...
本指南專為初學者設計。每個步驟都有詳細說明。如果遇到問題，請查看[疑難排解](#疑難排解常見問題)章節。
...
4. [方法 3: 手動安裝（最大掌控）](#方法-3-手動安裝最大掌控)
5. [驗證一切正常運作](#驗證一切正常運作)
6. [疑難排解常見問題](#疑難排解常見問題)
7. [下一步](#下一步)
...
2. **CPU 慢** - embedding 是 CPU 密集的
3. **RAM 不足** - 系統正在使用 swap
