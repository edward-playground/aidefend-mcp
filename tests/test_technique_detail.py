...
class TestFormatStrategies:
    ...
    def test_multiple_strategies(self):
        ...
        strategies = [
            {"strategy": "Strategy 1", "howTo": "How 1"},
            {"strategy": "Strategy 2", "howTo": "How 2"},
            {"strategy": "Strategy 3", "howTo": "How 3"}
        ]

        result = _format_strategies(strategies, include_code=False)

        assert len(result) == 3
        assert all('strategy' in s for s in result)
    ...
    def test_missing_fields(self):
        ...
        assert len(result) == 2
        assert result[0]['strategy'] == "Strategy Only"
...
class TestFlagsAndOptions:
    ...
    def test_code_not_included_when_false(self):
        ...
        strategies = [{"strategy": "Test", "howTo": "<pre><code>test</code></pre>"}]
        result = _format_strategies(strategies, include_code=False)
