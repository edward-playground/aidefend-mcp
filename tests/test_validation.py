...
class TestValidateTechniqueIDInputValidation:
    ...
    async def test_whitespace_trimmed(self):
        ...
        # This test assumes the function handles whitespace
        # We can't fully test without database, but format check should work
        result = await validate_technique_id("  AID-H-001  ")
        # If database not available, will get QueryEngineNotInitializedError
